...
public class FantasylandList {
	enum fantasyland {
		BIBBIDI_BOBBIDI_BOUTIQUE("Bibbidi Bobbidi Boutique", ""),
		BIG_TOP_SOUVENIRS("Big Top Souvenirs", ""),
	...
	enum fantasylandAttractions {
		MICKEYS_PHILHARMAGIC("Mickey's PhilharMagic", ""),
		ENCHANTED_TALES_WITH_BELLE("Enchanted Tales with Belle", ""),
		PRINCESS_FAIRYTALE_HALL("Princess Fairytale Hall", ""),
		FAIRYTALE_GARDEN("Fairytale Garden", ""),
		ARIELS_GROTTO("Ariels Grotto", ""),
		SPLASH_N_SOAK_STATION("Casey Jr. Splash 'N' Soak Station", ""),
	...
	enum fantasylandRestaurants {
		...
		CINDERELLAS_ROYAL_TABLE("Cinderella's Royal Table", ""),
		THE_FRIARS_NOOK("The Friars Nook", ""),
		STORYBOOK_TREATS("Storybook Treats", ""),
		BE_OUR_GUEST("Be Our Guest Restaurant", ""),
		GASTONS_TAVERN("Gaston's Tavern", ""),
